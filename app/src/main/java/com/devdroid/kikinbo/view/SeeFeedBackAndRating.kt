...
class SeeFeedBackAndRating : AppCompatActivity() {
    ...
    lateinit var productRatingBar: RatingBar
    lateinit var reviewsContainer: LinearLayout
    var productViewModel = ProductViewModel()  // Initialize ProductViewModel
     ...
     *                and reviews.
     */
    fun displayProductData(product: ProductDataModel) {
